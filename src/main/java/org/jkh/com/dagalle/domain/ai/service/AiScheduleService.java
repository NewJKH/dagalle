...
public class AiScheduleService {
    ...
    private String buildAllDaysSystemPrompt(String countryCode,
        ...
        String base = "JSON 배열만 응답. 마크다운 금지.\n" +
                ...
                " 하루 4~6개 route.\n" +
                "【장소 다양성 — 최우선 원칙】\n" +
                "관광지·사찰·박물관만 넣지 말 것. 현지인이 실제로 가는 다양한 장소를 자유롭게 배치:\n" +
                "- 먹거리 거리·상점가: 유후인 유노츠보 거리, 나시장 도구야스지, 오사카 쿠로몬시장, 도쿄 아메요코 등 (type=SHOPPING 또는 ETC, 체류 60~90분)\n" +
                "- 현지 마트·슈퍼: 이온(AEON), 라이프, 세이유, 코스트코, 돈키호테(드럭스토어 겸) — 기념품·식재료 구경 (type=SHOPPING, 체류 45~60분)\n" +
                "- 편의점 명소: 로손·세븐일레븐·패밀리마트도 경치 좋은 곳이면 방문 route 포함 가능 (type=ETC, 체류 15~20분)\n" +
                "- 지역 축제·마츠리: 여행 날짜에 그 지역 마츠리·축제가 실제로 열린다면 반드시 포함 (type=ETC, 체류 90~150분, note에 축제명과 개최 시간 기재)\n" +
                "- 아침 시장: 니시키시장, 츠키지 장외시장, 로컬 아사이치 — 현지 아침 분위기 (체류 45~60분)\n" +
                "- 드라이브인·도로변 명소: 경치 좋은 도로변 전망 휴게소, 유명 다리, 인스타 명소 (type=ETC, 체류 20~30분)\n" +
                "- 가볍게 들르는 로컬 카페·빵집·소프트아이스크림 가게 (type=CAFE, 체류 20~35분)\n" +
                "- 산책로·강변·해안 드라이브 코스 (type=PARK, 체류 30~60분)\n" +
                "하루 일정 중 '대표 관광지'는 최대 1~2곳, 나머지는 위 로컬 장소로 채울 것. 일정 내내 박물관·신사·성만 나열 금지.\n" +
    ...
    private String buildDaySystemPrompt(String countryCode,
        ...
        String base = "JSON만 응답. 마크다운 금지.\n스키마: " + DAY_SCHEMA + "\n" +
                ...
                " 4~6 route.\n" +
                "【장소 다양성 — 핵심 원칙】\n" +
                "관광지·사찰만 나열 금지. 하루 대표 관광지 최대 1~2곳, 나머지는 아래 로컬 장소로 채울 것:\n" +
                "- 먹거리 거리·상점가: 유후인 유노츠보 거리, 쿠로몬시장, 아메요코, 나시장 도구야스지 등 (type=SHOPPING/ETC, 60~90분)\n" +
                "- 현지 마트·드럭스토어: 이온, 돈키호테, 마츠모토키요시, 세이유 (type=SHOPPING, 45~60분)\n" +
                "- 지역 축제·마츠리: 여행 날짜에 실제 열리는 축제 있으면 반드시 포함 (type=ETC, 90~150분, note에 축제명·시간)\n" +
                "- 아침 시장·아사이치: 니시키시장, 츠키지 장외, 로컬 아침시장 (체류 45~60분)\n" +
                "- 로컬 카페·빵집·소프트아이스크림 (type=CAFE, 20~35분)\n" +
                "- 강변 산책로·해안도로·경치 좋은 도로변 (type=PARK/ETC, 20~40분)\n" +
