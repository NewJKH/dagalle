...
public class AiScheduleService {
    ...
    private String buildAllDaysSystemPrompt(String countryCode,
        ...
        String base = "JSON 배열만 응답. 마크다운 금지.\n" +
                ...
                "- 공항(AIRPORT): 국내선 대기 45분. 국제선 입국장 60분. 공항 내 이동은 route 아님.\n" +
                "- 호텔/숙소(HOTEL): 체크인 20~30분. 체크아웃 10~15분.\n" +
                "- 역·환승(STATION): 5~10분. 단순 환승은 route 분리 금지.\n" +
                "- 아침식사(RESTAURANT): 30~45분.\n" +
                "- 점심식사(RESTAURANT): 50~70분.\n" +
                "- 저녁식사(RESTAURANT 저녁): 70~90분. 이자카야·코스요리 90~120분.\n" +
                "- 카페(CAFE): 30~50분.\n" +
                "- 박물관·미술관·수족관(MUSEUM): 90~120분. 대형 국립박물관 120~150분.\n" +
                "- 신사·절 소형(ETC): 30~45분. 대형(후시미이나리·센소지·메이지신궁 등) 60~90분.\n" +
                "- 성(MUSEUM 또는 ETC): 60~90분.\n" +
                "- 공원 소형(PARK): 45~60분. 대형공원(우에노·하마리큐 등) 60~90분.\n" +
                "- 댐·전망대·관망포인트·야경스팟(ETC): 20~35분. 절대 60분 이상 배정 금지.\n" +
                "- 쇼핑몰·백화점·상점가(SHOPPING): 60~90분. 아케이드·대형쇼핑몰 90~120분.\n" +
                "- 시장·야타이(RESTAURANT/ETC): 45~60분.\n" +
                "- 온천·료칸 온천(ETC): 60~90분. 아침 온천 45~60분.\n" +
                "- 해수욕장·해변(PARK): 90~150분.\n" +
                "- 야경·루프탑바·야시장(ETC): 40~60분.\n" +
    ...
    private String buildDaySystemPrompt(String countryCode,
        ...
        String base = "JSON만 응답. 마크다운 금지.\n스키마: " + DAY_SCHEMA + "\n" +
                ...
                "【장소별 현실 체류시간 — 다음 route departureTime 계산 기준, 반드시 준수】\n" +
                "- 공항(AIRPORT): 입국 60분. 출국 수속 90분.\n" +
                "- 호텔(HOTEL): 체크인 20~30분. 체크아웃 10분.\n" +
                "- 역환승(STATION): 5~10분.\n" +
                "- 아침식사: 30~45분. 점심식사: 50~70분. 저녁식사: 70~90분. 이자카야/코스: 90~120분.\n" +
                "- 카페(CAFE): 30~50분.\n" +
                "- 박물관·미술관·수족관(MUSEUM): 90~120분.\n" +
                "- 신사·절 소형: 30~45분. 대형(후시미이나리·센소지·메이지신궁 등): 60~90분.\n" +
                "- 성(MUSEUM/ETC): 60~90분.\n" +
                "- 공원 소형(PARK): 45~60분. 대형공원: 60~90분.\n" +
                "- 댐·전망대·관망포인트·야경스팟(ETC): 20~35분. 절대 60분 초과 금지.\n" +
                "- 쇼핑몰·상점가(SHOPPING): 60~90분.\n" +
                "- 시장·야타이·포장마차: 45~60분.\n" +
                "- 온천(ETC): 60~90분.\n" +
                "- 해수욕장(PARK): 90~150분.\n" +
                "- 야경·루프탑·야시장: 40~60분.\n" +
